...
if column_A == row_B:
    ...
    while i < row_A:
        ...
        while j < column_B:
            ...
            j = j + 1
        multiplication_AB.append(temp_matrix)
        i = i + 1

    print("Multiplication of Matrix A & B: ")
    i = 0
    while i < len(multiplication_AB):
        j = 0
        while j < len(multiplication_AB[0]):
            print(multiplication_AB[i][j], end="\t")
            j = j + 1
        print()
        i = i + 1

else:
    print("The sizes of the matrix doesn't match to perform multiplication.")
